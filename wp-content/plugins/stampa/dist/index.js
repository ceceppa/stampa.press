...
function ComponentItem() {
  return _react.default.createElement("dd", null, "Ciao");
}
...
function ComponentsList() {
  ...
  return _react.default.createElement("div", {
    ...
    return _react.default.createElement("dl", {
      key: group
    }, _react.default.createElement("dt", null, group), Object.keys(blocks[group]).map(function (id) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "44217" + '/');
